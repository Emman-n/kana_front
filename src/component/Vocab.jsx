...
import { useNavigate  } from 'react-router-dom';
  ...
  const Vocab = () => {
    ...
    const [availableNumbers, setAvailableNumbers] = useState([...Array(10).keys()].map(i => i + 1));
    ...
    const fetchData = (id) => {
      axios
        .get(`https://kana-back.onrender.com/vocab/${id}`)
        .then((res) => {
          console.log(res);
          setVocab(res.data);
  ...
  return (
    ...
    <div className="container-xxl">
      <h1 className="">VOCABU</h1>
      <h7 className="">translate to english<br></br></h7>
      <h7 className="">enter to check answer</h7>
